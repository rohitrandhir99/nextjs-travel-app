...
const CampSite = ({backgroundImage, title, subTitle, peopleJoined}: CampProps) => (
  <div className={`h-full w-full min-w-[1100px] bg-cover bg-no-repeat lg:rounded-5xl 2xl:rounded-5xl  ${backgroundImage}`}>
  ...
  return (
    ...
    >
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        xl:max-w-[734px] xl:roundex-5xl xl:px-16 xl:py-20 
        ...
        >
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            ...
            the possibility of getting lost is very large. Thats why we are here for those of 
